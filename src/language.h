...
const char CLOCK_MONDAY[] PROGMEM = "Monday";
const char CLOCK_TUESDAY[] PROGMEM = "Tuesday";
const char CLOCK_WEDNESDAY[] PROGMEM = "Wednesday";
const char CLOCK_THURSDAY[] PROGMEM = "Thursday";
const char CLOCK_FRIDAY[] PROGMEM = "Friday";
const char CLOCK_SATURDAY[] PROGMEM = "Saturday";
const char CLOCK_SUNDAY[] PROGMEM = "Sunday";
...
const char CLI_SAVE_PHONE_CREDENTIAL[] PROGMEM = "savephone";
const char CLI_SAVE_ZALO_CREDENTIAL[] PROGMEM = "savezalo";
const char CLI_SAVE_TWITTER_CREDENTIAL[] PROGMEM = "savetwitter";
const char CLI_SAVE_WIFI_CREDENTIAL[] PROGMEM = "savewifi";
const char CLI_PHONE_CREDENTIAL[] PROGMEM = "phone";
const char CLI_FACEBOOK_CREDENTIAL[] PROGMEM = "facebook";
const char CLI_ZALO_CREDENTIAL[] PROGMEM = "zalo";
const char CLI_TWITTER_CREDENTIAL[] PROGMEM = "twitter";
const char CLI_WIFI_CREDENTIAL[] PROGMEM = "wifi";
const char CLI_CREDENTIAL_DELETE[] PROGMEM = "credentialdelete";

const char CLI_HELP_HELP[] PROGMEM = "help";
const char CLI_HELP_SCAN[] PROGMEM = "scan [<all/aps/stations>] [-t <time>] "
                                     "[-c <continue-time>] [-ch <channel>]";
const char CLI_HELP_SHOW[] PROGMEM =
    "show [selected] [<all/aps/stations/names/ssids>]";
const char CLI_HELP_SELECT[] PROGMEM =
    "select [<all/aps/stations/names>] [<id>]";
const char CLI_HELP_DESELECT[] PROGMEM =
...
const char CLI_HELP_NAME_C[] PROGMEM =
...
const char CLI_HELP_SEND_DEAUTH[] PROGMEM =
    "send deauth <apMac> <stMac> <rason> <channel>";
const char CLI_HELP_SEND_BEACON[] PROGMEM =
...
const char CLI_HELP_SCREEN_MODE[] PROGMEM =
...
const char CLI_RICE_START[] PROGMEM =
    "Starting rice debugger (auto - repair mode enabled), please stand "
    "by...\r\nKeep the device connected to a power supply until the debugger "
    "ends\r\nYOU RISK TO BRICK THE BOARD!!!";
const char CLI_RICE_OUTPUT[] PROGMEM = "[ % d % % ]\r\n";
const char CLI_RICE_ERROR[] PROGMEM =
...
const char D_HACK_AND_CAPTIVE_PORTAL[] PROGMEM = "Hack & Captive portal";
const char D_CREDENTIAL[] PROGMEM = "Credential";
const char D_WIFI[] PROGMEM = "Wi Fi";
const char D_HACK_WIFI[] PROGMEM = "Hack Wi Fi";
const char D_GAME[] PROGMEM = "Game";
const char D_BRIGHTNESS[] PROGMEM = "Brightness";
const char D_TIME_ON_SCREEN[] PROGMEM = "On Screen Time";
...
const char D_GAME_FLAPPY_BIRD[] PROGMEM = "Flappy Bird";
const char D_GAME_PONG[] PROGMEM = "Pong";
const char D_GAME_CAR_RACE[] PROGMEM = "Car";
...
// TIME ON DISPLAY
const char D_TIME_1M[] PROGMEM = "1 minute";
const char D_TIME_2M[] PROGMEM = "2 minutes";
const char D_TIME_3M[] PROGMEM = "3 minutes";
const char D_TIME_4M[] PROGMEM = "4 minutes";
const char D_TIME_5M[] PROGMEM = "5 minutes";
const char D_TIME_10M[] PROGMEM = "10 minutes";
...
// SUB CAPTIVE PORTAL twitter
const char D_CAPTIVE_PORTAL_ON_WITH[] PROGMEM = "Captive portal With";
const char D_CAPTIVE_PORTAL_ON_ALL[] PROGMEM = "with all";
const char D_CAPTIVE_PORTAL_ON_WITH_PHONE[] PROGMEM = "with phone";
const char D_CAPTIVE_PORTAL_ON_WITH_FACEBOOK[] PROGMEM = "with facebook";
const char D_CAPTIVE_PORTAL_ON_WITH_ZALO[] PROGMEM = "with zalo";
const char D_CAPTIVE_PORTAL_ON_WITH_TWITTER[] PROGMEM = "with twitter";
const char D_CAPTIVE_PORTAL_OFF_MESSAGE[] PROGMEM = "Turn off";
const char D_CAPTIVE_PORTAL_ALL[] PROGMEM = "all";

// SUB CREDENTIAL

const char D_MESSAGE_RESET_DEVICE[] PROGMEM = "you want erase?";
const char D_TITLE_REBOOT_DEVICE[] PROGMEM = "Reboot";
const char D_MESSAGE_REBOOT_DEVICE[] PROGMEM = "you want reboot?";
const char D_REBOOT_BUTTON[] PROGMEM = "Reboot";

// RESET SCREEN
const char D_CLEAR_SSID[] PROGMEM = "CLEAR SSID";
const char D_SET_PASSWORD[] PROGMEM = "SET PASSWORD";
const char D_SET_NONE_PASS[] PROGMEM = "NONE PASS";
const char D_SET_CHANNEL[] PROGMEM = "CHANNEL";
const char D_SET_HIDDEN_WIFI[] PROGMEM = "HIDDEN WIFI";
const char D_SET_CAPTIVE[] PROGMEM = "CAPTIVE PORTAL";
const char D_SET_LANGUAGE[] PROGMEM = "SET LANG EN";
const char D_RESET_DONE[] PROGMEM = "RESET OK";
const char D_DONE[] PROGMEM = "OK";
// const char D_FALSE[] PROGMEM = "FALSE";

// STATUS INDICATOR
const char D_SUCCESS[] PROGMEM = "Success";
const char D_SET_NETWORK_FALSE[] PROGMEM = "PLS CHOOSE NETWORK";
const char D_FALSE[] PROGMEM = "Failure ???";

const char D_TITLE_TURN_ON_CAPTIVE[] PROGMEM = "Turn on";
const char D_TITLE_TURN_OFF_CAPTIVE[] PROGMEM = "Turn off";
const char D_TITLE_DELETE_CREDENTIAL[] PROGMEM = "Credential delete";
const char D_TITLE_TURN_ON_WIFI[] PROGMEM = "Turn on Wi Fi";
const char D_TITLE_TURN_OFF_WIFI[] PROGMEM = "Turn off Wi Fi";
const char D_TITLE_DISCONNECT_WIFI[] PROGMEM = "Disconnect Wi-Fi";
const char D_TITLE_SET_CAPTIVE_NAME_WIFI[] PROGMEM = "Wi-Fi name";
const char D_TITLE_SET_CAPTIVE_START_WIFI_HACKING[] PROGMEM =
    "Hack Wi-Fi start";
const char D_TITLE_SET_CAPTIVE_STOP_WIFI_HACKING[] PROGMEM = "Hack Wi-Fi stop";
const char D_AGREE_ERASE_CREDENTIAL[] PROGMEM = "Erase";

const char D_IP_NAME[] PROGMEM = "ip";
const char D_CAPTIVE_NAME[] PROGMEM = "captive";
const char D_CREDENTIAL_WITH[] PROGMEM = "with";
const char D_DEAUTHER_STATUS[] PROGMEM = "deauther";

// SUB SMARTCONFIG
const char D_WIFI_CONNECTED[] PROGMEM = "WI-FI connected";
const char D_WIFI_SMARTCONFIG_CONNECT[] PROGMEM = "Smart Config";
const char D_WIFI_CONNECT_FALSE[] PROGMEM = "WI-FI false";
// WFI SCREEN
const char D_ADD_NEW_WIFI[] PROGMEM = "Add new Wi-Fi";
const char D_CREATE_CAPTIVE_PORTAL[] PROGMEM = "Captive portal ";
const char D_SELECT_VICTIM[] PROGMEM = "Select victim";
const char D_CREATE_NEW_SSID[] PROGMEM = "Create ssid";
const char D_GET_WIFI_SCAN_HACK_WIFI[] PROGMEM = "Scan && Hack WiFi";
const char D_DISCONNECT_WIFI[] PROGMEM = "Disconnect";
const char D_OFF_WIFI[] PROGMEM = "[On] Turn off";
const char D_ON_WIFI[] PROGMEM = "[Off] Turn on";
const char D_INPUT_WIFI[] PROGMEM = "input ssid";
...
// ALERT
const char D_CANCEL_BUTTON[] PROGMEM = "Cancel";
const char D_AGREE_BUTTON[] PROGMEM = "Ok";
...
const char D_SET_NONE_PASS_FOR_SSID[] PROGMEM = "none password";
const char D_HACK_SSID[] PROGMEM = "hack this ssid";
const char D_SET_ATTACK_TIMEOUT[] PROGMEM = "set timeout";
const char D_SET_ATTACK_TIMEOUT_MIN_ERROR[] PROGMEM = "time >= 60s";
const char D_INPUT_NUMBER_WRONG_FORMAT[] PROGMEM = "just accept number";
const char D_INPUT_EMPTY[] PROGMEM = "empty number";
const char D_EXIT_GAME[] PROGMEM = "Exit";
const char D_EXIT_GAME_MESSAGE[] PROGMEM = "do you want exit?";
const char D_ADD_EXTENSION_NAME_SSID[] PROGMEM = "add extension name";
...
const char S_ERROR_VERSION[] PROGMEM =
    "Sorry, you can't change the version number";
...
const char L_NOT_CONFIGURED[] PROGMEM =
    "ERROR: No LED is configured in A_config.h!";
...
const char N_TABLE_HEADER[] PROGMEM = "ID MAC               Vendor   Name      "
                                      "       AP-BSSID          Ch Selected";
...
const char SS_ERROR_FULL[] PROGMEM =
    "ERROR: SSID list is full! Remove some SSIDs first or run command with -f "
    "(force) parameter.";
...
const char SS_JSON_DEFAULT[] PROGMEM =
    "{\"random\":false,\"ssids\":[[\"Never gonna give you "
    "up\",false,23],[\"Never gonna let you down\",false,24],[\"Never gonna run "
    "around\",false,22],[\"Never gonna make you cry\",false,24],[\"Never gonna "
    "say goodbye\",false,23],[\"Never gonna tell a lie\",false,22],[\"Never "
    "gonna hurt you\",false,20],[\"Never gonna desert you\",false,22]]}";
const char SS_RANDOM_INFO[] PROGMEM =
    "Generating new SSIDs... Type \"disable random\" to stop the random mode";

// ===== SCAN ==== //
const char SC_START_CLIENT[] PROGMEM =
    "Starting Scan for stations (client devices) - ";
const char SS_START_SNIFFER[] PROGMEM = "Starting packet sniffer - ";
const char SC_ERROR_NO_AP[] PROGMEM =
    "ERROR: AP-list empty! Can't scan for clients, please Scan for "
    "Accesspoints first.";
const char SC_INFINITELY[] PROGMEM = " infinitely";
const char SC_ON_CHANNEL[] PROGMEM = " on channel ";
const char SC_START_AP[] PROGMEM =
...
const char SC_CONTINUE[] PROGMEM =
    "s - type stop to disable the continuous mode";
